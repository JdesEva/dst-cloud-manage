...
const startInstall = async () => {
  ...
  const stepList = [
    {
      step: QuicklyInstallStep.UPDATE_PACKAGE,
      progress: 10,
      text: t('install.update-package'),
      fail: t('result.update-package-fail'),
    },
    {
      step: QuicklyInstallStep.INSTALL_DEPEND,
      progress: 20,
      text: t('install.install-depend'),
      fail: t('result.install-depend-fail'),
    },
    {
      step: QuicklyInstallStep.DOWNLOAD_STEAM_CMD,
      progress: 30,
      text: t('install.download-steamcmd'),
      fail: t('result.download-steamcmd-fail'),
    },
    {
      step: QuicklyInstallStep.INSTALL_STEAM_CMD,
      progress: 40,
      text: t('install.install-steamcmd'),
      fail: t('result.install-steamcmd-fail'),
    },
  ];
