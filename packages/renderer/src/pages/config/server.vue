        ...
        >
          ...
          <n-form-item :label="t('server.port')" path="port">
            <n-input-number
              ...
              :min="0"
              type="number"
              :placeholder="t('server.port-required')"
            />
          </n-form-item>
          ...
          <n-form-item :label="t('server.password')" path="password">
            <n-input
              ...
              :placeholder="t('server.password-required')"
            />
          </n-form-item>
          <div style="display: flex; justify-content: flex-end">
            <n-space :size="24">
              <n-button round :type="connectMap[connectFlag]" @click="validateServerConnect"> 连接测试 </n-button>
