        ...
        >
          ...
          <n-form-item :label="t('translate.bd-key')" path="key">
            <n-input
              ...
              :placeholder="t('translate.bd-key-required')"
            />
          </n-form-item>
          <n-form-item :label="t('translate.from')" path="from">
            <n-select v-model:value="model.from" :placeholder="t('translate.from-required')" :options="computedFrom" />
          </n-form-item>
          <n-form-item :label="t('translate.to')" path="to">
            <n-select v-model:value="model.to" :placeholder="t('translate.to-required')" :options="computedTo" />
          </n-form-item>
